...
**Задача:** Автоматически создавать базовую профессию при создании проекта, чтобы можно было начать тестировать расчёты.

**Что нужно сделать:**

1. Обновить `handlers/projects.py`
   - После создания проекта автоматически создавать профессию
   - Добавить базовые прогрессивные ставки
   - Добавить базовые дополнительные услуги

2. Протестировать создание проекта через бота

**После выполнения:**
- Протестировать через бота командой /new_project
- Проверить, что профессия создаётся автоматически
- Обновить STATUS.md
- Сделать коммит: "Шаг 3.2: Автосоздание профессии"
- Перейти к Шагу 3.3
