...
## Фаза 4: Telegram Mini App 🚧 В процессе
...
- [ ] Шаг 4.5: Прогрессивные ставки (динамический список) 🚧
- [ ] Шаг 4.6: Дополнительные услуги (динамический список) 🚧
- [ ] Шаг 4.7: Валидация и отправка данных 🚧
- [ ] Шаг 4.8: Обработка в боте и сохранение 🚧

## Что работает:
- ✅ Mini App открывается в Telegram
- ✅ Форма для настройки проекта (базовая версия)
- ✅ HTTPS через ngrok
- ✅ Автоматический расчёт брутто (в консоли)

## Следующий шаг:
Шаг 4.5: Добавить динамические прогрессивные ставки